...
import { CreatePaymentsV4CommandDto } from './create-payment.dto';
...
export class CreatePaymentHandler
  implements
    ICommandHandler<CreatePaymentsV4Command, CreatePaymentsV4CommandDto>
{
  constructor(
  ...
  ): Promise<CreatePaymentsV4CommandDto | null> {
